...
urlpatterns = [
    ...
    # path("<int:tournament_id>/solo_game/", views.solo_game, name="solo_game"),
    path("<int:any_number>/solo_game/", views.solo_game, name="solo_game"), #TODO: replace by the above url
